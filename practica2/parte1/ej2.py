...
# Counter es una subclase de diccionario para ir contando las apariciones de un elemento en una coleccion dada
for palabra in texto_palabras:
    contador[palabra] += 1

# El método most_common(n) devuelve las n palabras con más ocurrencias en forma de lista de tuplas, con sus respectivas cantidades
mas_comun = contador.most_common(1)[0]
# El tipo de mas_comun es tupla

print(f'La palabra que mas aparece en el readme es \'{mas_comun[0]}\', con {mas_comun[1]} veces')